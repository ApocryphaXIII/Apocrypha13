/datum/outfit/job/vampire/leopold_ert
	name = "Society of Leopold Heavy Inquisitor"
	ears = /obj/item/radio/headset/darkpack/inquisitor
	uniform = /obj/item/clothing/under/vampire/inquisitor
	suit = /obj/item/clothing/suit/vampire/inquisitor
