...
/datum/outfit/job/vampire/duskborn
	...
	backpack_contents = list(/obj/item/vamp/keys/duskborn/primogen=1, /obj/item/card/credit/elder=1, /obj/item/card/whip, /obj/item/card/steward, /obj/item/card/myrmidon, /obj/item/smartphone/duskborn_primo)
