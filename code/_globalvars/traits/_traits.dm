...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/datum/controller/subsystem/processing/station = list(
		...
		"STATION_TRAIT_PUN_PUN_GYM_DAY" = STATION_TRAIT_PUN_PUN_GYM_DAY,
	...
	/obj = list(
		...
		"TRAIT_COZY_REVENANT_HOME" = TRAIT_COZY_REVENANT_HOME,
	),
	/mob = list(
		...
		"TRAIT_BLOOD_HUD" = TRAIT_BLOOD_HUD,
		"TRAIT_BLOOD_WORM_HOST" = TRAIT_BLOOD_WORM_HOST,
		...
		"TRAIT_DONT_HEAR_PRAYERS" = TRAIT_DONT_HEAR_PRAYERS,
		...
		"TRAIT_ECHOLOCATOR" = TRAIT_ECHOLOCATOR,
		...
		"TRAIT_ETHEREAL_METABOLISM" = TRAIT_ETHEREAL_METABOLISM,
		...
		"TRAIT_GHOSTLY_MOB" = TRAIT_GHOSTLY_MOB,
		...
		"TRAIT_HIDE_THINKING_INDICATOR" = TRAIT_HIDE_THINKING_INDICATOR,
		...
		"TRAIT_LESSER_HUMANOID" = TRAIT_LESSER_HUMANOID,
		...
		"TRAIT_LIZARD_METABOLISM" = TRAIT_LIZARD_METABOLISM,
		...
		"TRAIT_NIGHTMARISH" = TRAIT_NIGHTMARISH,
		...
		"TRAIT_REQUIRED_ADV_HEALTH_SCANNER" = TRAIT_REQUIRED_ADV_HEALTH_SCANNER,
		...
		"TRAIT_SURGERY_INAPPLICABLE" = TRAIT_SURGERY_INAPPLICABLE, // DARKPACK EDIT ADD
		...
		"TRAIT_VOMIT_SLURPER" = TRAIT_VOMIT_SLURPER,
		...
		"TRAIT_ALWAYS_CLEAN" = TRAIT_ALWAYS_CLEAN, // DARKPACK EDIT ADD - ANANASI
		...
		"TRAIT_BLOOD_OF_PAIN" = TRAIT_BLOOD_OF_PAIN, // DARKPACK EDIT ADD - ANANASI
		...
		"TRAIT_HARDENED_SOLES" = TRAIT_HARDENED_SOLES, // DARKPACK EDIT ADD
		...
		"TRAIT_MONSTROUS" = TRAIT_MONSTROUS, // DARKPACK EDIT ADD - MERITS_FLAWS
		...
		"TRAIT_THIRST_OF_AGES" = TRAIT_THIRST_OF_AGES, // DARKPACK EDIT ADD - MERITS_FLAWS - (Thirst of ages)
		...
		"TRAIT_VAMPIRE_TERRITORIAL" = TRAIT_VAMPIRE_TERRITORIAL, // DARKPACK EDIT ADD - MERITS_FLAWS
		"TRAIT_VICTIM_OF_THE_MASQUERADE" = TRAIT_VICTIM_OF_THE_MASQUERADE, // DARKPACK EDIT ADD - MERITS_FLAWS
		...
		"TRAIT_WYRMLING_KINSHIP" = TRAIT_WYRMLING_KINSHIP, // DARKPACK EDIT ADD - ANANASI
		...
		"TRAIT_ANTHROPIC_TASTE" = TRAIT_ANTHROPIC_TASTE, //DARKPACK EDIT ADD - MERITS_FLAWS
	),
	...
	/obj/item = list(
		...
		"TRAIT_CASTING_CLOTHING" = TRAIT_CASTING_CLOTHING,
		...
		"TRAIT_GRILLABLE" = TRAIT_GRILLABLE,
		...
		"TRAIT_MICROWAVABLE" = TRAIT_MICROWAVABLE,
		...
		"TRAIT_ELEVATED_FLAME" = TRAIT_ELEVATED_FLAME, // DARKPACK EDIT ADD - TURF_FIRE
	),
	...
	/obj/item/fish = list(
		...
		"TRAIT_FISH_GENEGUNNED" = TRAIT_FISH_GENEGUNNED,
		"TRAIT_FISH_INK_ON_COOLDOWN" = TRAIT_FISH_INK_ON_COOLDOWN,
		"TRAIT_FISH_JUST_SPAWNED" = TRAIT_FISH_JUST_SPAWNED,
	...
	/turf = list(
		...
		"TRAIT_TURF_BLESSED" = TRAIT_TURF_BLESSED,
		...
		"TRAIT_TURF_PROJECTS_WHISPERS" = TRAIT_TURF_PROJECTS_WHISPERS,
